...
from .agent import BeakerMineralsAgent
...
class BeakerMineralsContext(BeakerContext):
    """
    Beaker context for critical minerals analysis
    """

    agent_cls: "BeakerAgent" = BeakerMineralsAgent
    
    WEIGHT: int = 10
    SLUG: str = "beaker_minerals"
