...
class BeakerMineralsAgent(BeakerAgent):
    """
    You are the Beaker Minerals Agent, a chat assistant that helps users with mineral research tasks.
    """
    ...
    # @tool()
    # async def list_files(self, agent: AgentRef) -> List[str]:
    #     """
    #     List the files in the working directory.

    #     Args:
    #         agent (AgentRef): The agent reference object

    #     Returns:
    #         List[str]: A list of files in the working directory.
    #     """
    #     code = agent.context.get_code("list_current_dir")
